exports.single = function(stop,amount,callback){

	// remove whitespace, vvo-online.de handles all kinds of requests pretty nicely
	stop = stop.replace(/ /g, '');

	// ort = name of the city, not sure what this can be besides 'Dresden'
	...
	var options = {
		...
		path: '/abfahrtsmonitor/Abfahrten.do?ort=Dresden&hst=' + stop + '&vz=0&lim=' + amount
	};
