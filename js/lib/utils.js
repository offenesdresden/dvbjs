...
function parsePin(dataAsString, pinType) {
    ...
    if (pinType === interfaces_1.PIN_TYPE.poi || pinType === interfaces_1.PIN_TYPE.rentabike
        || pinType === interfaces_1.PIN_TYPE.ticketmachine || pinType === interfaces_1.PIN_TYPE.carsharing
        || pinType === interfaces_1.PIN_TYPE.parkandride) {
        return {
            coords: coords,
            id: data[0],
            name: data[3],
