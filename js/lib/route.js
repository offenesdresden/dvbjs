...
function extractTrip(trip) {
    var nodes = trip.PartialRoutes.map(function (node) { return extractNode(node, trip.MapData); });
    return {
        nodes: nodes,
...
function route(originID, destinationID, time, isArrivalTime, callback) {
    if (time === void 0) { time = new Date(); }
    if (isArrivalTime === void 0) { isArrivalTime = true; }
    var options = {
