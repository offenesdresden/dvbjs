...
describe('dvb.monitor', function () {
    ...
    describe('dvb.monitor 33000037 (Postplatz)', function () {
        ...
        it('should return an array with elements', function () { return dvb.monitor('33000037', 10, 5)
            .then(function (data) {
            assert.isArray(data);
            assert.lengthOf(data, 5);
        }); });
        it('should contain all fields', function () { return dvb.monitor('33000037', 0, 5)
            .then(function (data) {
    ...
    describe('dvb.monitor "xyz"', function () {
        ...
        it('should reject with ValidationError', function () { return assert.isRejected(dvb.monitor('xyz'), 'stopid has to be not null and must be a number'); });
    ...
    describe('dvb.monitor 123 (invalid id)', function () {
        ...
        it('should reject with ServiceError', function () { return assert.isRejected(dvb.monitor('1242142343'), 'stop invalid'); });
...
describe('dvb.route', function () {
    describe('dvb.route "33000742 (Helmholtzstraße) -> 33000037 (Postplatz)"', function () {
        ...
        it('should return the correct origin and destination', function () { return dvb.route('33000742', '33000037', new Date(), false)
            .then(function (data) {
        ...
        it('should return an array of trips', function () { return dvb.route('33000742', '33000037', new Date(), false)
            .then(function (data) {
    ...
    describe('dvb.route "0 -> 0"', function () {
        ...
        it('should return empty trips', function () { return dvb.route('0', '0')
            .then(function (data) {
    ...
    describe('dvb.route "Helmholtzstraße -> Postplatz"', function () {
        ...
        it('should return empty trips', function () { return dvb.route('Helmholtzstraße', 'Postplatz')
            .then(function (data) {
            assert.isObject(data);
            assert.isUndefined(data.origin);
            assert.isUndefined(data.destination);
...
describe('dvb.findStop', function () {
    describe('dvb.findStop "Postplatz"', function () {
        ...
        it('should return an array', function () { return dvb.findStop('Postpl')
            .then(function (data) {
            assert.isNotEmpty(data);
        }); });
        it('should contain objects with name, city, coords and type', function () { return dvb.findStop('Postpl')
            .then(function (data) {
            assert.isNotEmpty(data);
        ...
        it('should find the correct stop', function () { return dvb.findStop('Postpl')
            .then(function (data) {
    ...
    describe('dvb.findStop "0"', function () {
        ...
        it('should return an empty array', function () { return dvb.findStop('0')
            .then(function (data) {
            assert.isEmpty(data);
        }); });
    });
    describe('dvb.findStop "xyz"', function () {
        ...
        it('should return an empty array', function () { return dvb.findStop('xyz')
            .then(function (data) {
            assert.isEmpty(data);
        }); });
    });
    describe('dvb.findStop "123"', function () {
        ...
        it('should reject with ServiceError', function () { return assert.isRejected(dvb.findStop('123'), 'stop invalid'); });
        it('should return ServiceError with callback', function (done) {
...
describe('dvb.findPOI', function () {
    describe('dvb.findPOI "Frauenkirche Dresden"', function () {
        ...
        it('should return an array', function () { return dvb.findPOI('Frauenkirche Dresden')
            .then(function (data) {
            assert.isNotEmpty(data);
        }); });
        it('should find the correct POIS', function () { return dvb.findPOI('Frauenkirche Dresden')
            .then(function (data) {
    ...
    describe('dvb.findPOI "xyz"', function () {
        ...
        it('should return an empty array', function () { return dvb.findPOI('xyz')
            .then(function (data) {
            assert.isEmpty(data);
        }); });
    });
    describe('dvb.findPOI "123"', function () {
        ...
        it('should reject with SeviceError', function () { return assert.isRejected(dvb.findPOI('123'), 'stop invalid'); });
        it('should return ServiceError with callback', function (done) {
...
describe('dvb.pins', function () {
    describe('dvb.pins "51.026578, 13.713899, 51.035565, 13.737974, stop"', function () {
        ...
        it('should resolve into an array', function () { return dvb.pins(51.026578, 13.713899, 51.035565, 13.737974, dvb.PIN_TYPE.stop)
            .then(function (data) {
            assert.isNotEmpty(data);
        }); });
        it('should contain objects with id, name, coords and connections', function () { return dvb.pins(51.026578, 13.713899, 51.035565, 13.737974, dvb.PIN_TYPE.stop)
            .then(function (data) {
        ...
        it('should return a promise but still accept a callback', function (done) {
            dvb.pins(51.026578, 13.713899, 51.035565, 13.737974, dvb.PIN_TYPE.stop, function (err, data) {
                assert.isNull(err);
                assert(data);
                done();
            }).then(assert);
    ...
    describe('dvb.pins "51.026578, 13.713899, 51.035565, 13.737974, platform"', function () {
        ...
        it('should contain objects with name, coords and platform_nr', function () { return dvb.pins(51.026578, 13.713899, 51.035565, 13.737974, dvb.PIN_TYPE.platform)
            .then(function (data) {
    ...
    describe('dvb.pins "51.026578, 13.713899, 51.035565, 13.737974, POI"', function () {
        ...
        it('should contain objects with name, coords and id', function () { return dvb.pins(51.026578, 13.713899, 51.035565, 13.737974, dvb.PIN_TYPE.poi)
            .then(function (data) {
            assert.notEqual(0, data.length);
            data.forEach(function (elem) {
                assert.isString(elem.id);
    ...
    describe('dvb.pins "0, 0, 0, 0, stop"', function () {
        ...
        it('should resolve into an empty array', function () { return dvb.pins(0, 0, 0, 0, dvb.PIN_TYPE.stop)
            .then(function (data) {
            assert.isArray(data);
...
describe('dvb.findAddress', function () {
    describe('dvb.findAddress "51.025451, 13.722943"', function () {
        ...
        var lat = 51.025451;
        var lng = 13.722943;
        it('should resolve into an object with city, address and coords properties', function () { return dvb.findAddress(lat, lng)
        ...
        it('should contain nearby stops', function () { return dvb.findAddress(lat, lng)
            .then(function (address) {
    ...
    describe('dvb.findAddress "0, 0"', function () {
        ...
        it('should reject with ServiceError', function () { return assert.isRejected(dvb.findAddress(0, 0), 'no it connection'); });
        it('should return ServiceError with callback', function (done) {
...
describe('dvb.coords', function () {
    describe('dvb.coords "33000755"', function () {
        ...
        it('should resolve into a coordinate array [lat, lng]', function () { return dvb.coords('33000755')
            .then(function (data) {
            assertCoords(data);
        }); });
        it('should return a promise but still accept a callback', function (done) {
    ...
    describe('dvb.coords "123"', function () {
        ...
        it('should return null', function () { return dvb.coords('123')
            .then(function (data) {
            assert.isNull(data);
        }); });
    });
...
describe('dvb.coords for id from dvb.pins', function () {
    ...
    it('coordinates should be equal for first pin', function () { return dvb.pins(51.026578, 13.713899, 51.035565, 13.737974, dvb.PIN_TYPE.poi)
        .then(function (pins) {
...
describe('dvb.lines', function () {
    describe('dvb.lines "33000037" (Postplatz)', function () {
        ...
        it('should return an array', function () { return dvb.lines('33000037')
            .then(function (data) {
            assert.isNotEmpty(data);
        }); });
        it('should contain objects with name, mode, diva and directions', function () { return dvb.lines('33000037')
            .then(function (data) {
    ...
    describe('dvb.lines "123"', function () {
        ...
        it('should reject with ServiceError', function () { return assert.isRejected(dvb.lines('123'), 'stop invalid'); });
        it('should return ServiceError with callback', function (done) {
    ...
    describe('parseMode', function () {
        ...
        mots.forEach(function (mot) {
            it('should parse `' + mot[0] + '` to `' + mot[1] + '`', function (done) {
                var mode = utils.parseMode(mot[0]);
                assertMode(mode);
